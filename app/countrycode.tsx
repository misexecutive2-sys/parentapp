...
export const COUNTRY_LIST: Country[] = [
 { cca2: "AF", name: "Afghanistan", flag: "🇦🇫", code: "+93" },
  ...
  { cca2: "BM", name: "Bermuda", flag: "🇧🇲", code: "+1441" },
  { cca2: "BT", name: "Bhutan", flag: "🇧🇹", code: "+975" },
  { cca2: "BO", name: "Bolivia", flag: "🇧🇴", code: "+591" },
  { cca2: "BQ", name: "Bonaire", flag: "🇧🇶", code: "+5997" },
  { cca2: "BA", name: "Bosnia and Herzegovina", flag: "🇧🇦", code: "+387" },
  { cca2: "BW", name: "Botswana", flag: "🇧🇼", code: "+267" },
  { cca2: "BV", name: "Bouvet Island", flag: "🇧🇻", code: "+47" },
  { cca2: "BR", name: "Brazil", flag: "🇧🇷", code: "+55" },
  { cca2: "IO", name: "British Indian Ocean Territory", flag: "🇮🇴", code: "+246" },
  { cca2: "VG", name: "British Virgin Islands", flag: "🇻🇬", code: "+1284" },
  ...
  { cca2: "CV", name: "Cape Verde", flag: "🇨🇻", code: "+238" },
  { cca2: "KY", name: "Cayman Islands", flag: "🇰🇾", code: "+1345" },
  ...
  { cca2: "TL", name: "East Timor", flag: "🇹🇱", code: "+670" },
  ...
  { cca2: "FK", name: "Falkland Islands", flag: "🇫🇰", code: "+500" },
  { cca2: "FO", name: "Faroe Islands", flag: "🇫🇴", code: "+298" },
  { cca2: "FJ", name: "Fiji", flag: "🇫🇯", code: "+679" },
  { cca2: "FI", name: "Finland", flag: "🇫🇮", code: "+358" },
  { cca2: "FR", name: "France", flag: "🇫🇷", code: "+33" },
  { cca2: "GF", name: "French Guiana", flag: "🇬🇫", code: "+594" },
  { cca2: "PF", name: "French Polynesia", flag: "🇵🇫", code: "+689" },
  { cca2: "TF", name: "French Southern Territories", flag: "🇹🇫", code: "+262" },
  ...
  { cca2: "GI", name: "Gibraltar", flag: "🇬🇮", code: "+350" },
  { cca2: "GR", name: "Greece", flag: "🇬🇷", code: "+30" },
  { cca2: "GL", name: "Greenland", flag: "🇬🇱", code: "+299" },
  { cca2: "GD", name: "Grenada", flag: "🇬🇩", code: "+1473" },
  { cca2: "GP", name: "Guadeloupe", flag: "🇬🇵", code: "+590" },
  { cca2: "GU", name: "Guam", flag: "🇬🇺", code: "+1671" },
  { cca2: "GT", name: "Guatemala", flag: "🇬🇹", code: "+502" },
  { cca2: "GG", name: "Guernsey", flag: "🇬🇬", code: "+44" },
  ...
  { cca2: "HM", name: "Heard Island and McDonald Islands", flag: "🇭🇲", code: "+61" },
  { cca2: "HN", name: "Honduras", flag: "🇭🇳", code: "+504" },
  { cca2: "HK", name: "Hong Kong", flag: "🇭🇰", code: "+852" },
  ...
  { cca2: "XK", name: "Kosovo", flag: "🇽🇰", code: "+377" },
  ...
  { cca2: "MO", name: "Macao", flag: "🇲🇴", code: "+853" },
  ...
  { cca2: "MS", name: "Montserrat", flag: "🇲🇸", code: "+1664" },
  { cca2: "MA", name: "Morocco", flag: "🇲🇦", code: "+212" },
  { cca2: "MZ", name: "Mozambique", flag: "🇲🇿", code: "+258" },
  { cca2: "MM", name: "Myanmar (Burma)", flag: "🇲🇲", code: "+95" },
  ...
  { cca2: "NC", name: "New Caledonia", flag: "🇳🇨", code: "+687" },
  ...
  { cca2: "NU", name: "Niue", flag: "🇳🇺", code: "+683" },
  { cca2: "NF", name: "Norfolk Island", flag: "🇳🇫", code: "+672" },
  { cca2: "KP", name: "North Korea", flag: "🇰🇵", code: "+850" },
  { cca2: "MK", name: "North Macedonia", flag: "🇲🇰", code: "+389" },
  { cca2: "MP", name: "Northern Mariana Islands", flag: "🇲🇵", code: "+1670" },
  ...
  { cca2: "PS", name: "Palestine", flag: "🇵🇸", code: "+970" },
  ...
  { cca2: "PN", name: "Pitcairn Islands", flag: "🇵🇳", code: "+64" },
  { cca2: "PL", name: "Poland", flag: "🇵🇱", code: "+48" },
  { cca2: "PT", name: "Portugal", flag: "🇵🇹", code: "+351" },
  { cca2: "PR", name: "Puerto Rico", flag: "🇵🇷", code: "+1787" },
  { cca2: "QA", name: "Qatar", flag: "🇶🇦", code: "+974" },
  { cca2: "CG", name: "Republic of the Congo", flag: "🇨🇬", code: "+242" },
  { cca2: "RE", name: "Reunion", flag: "🇷🇪", code: "+262" },
  { cca2: "RO", name: "Romania", flag: "🇷🇴", code: "+40" },
  { cca2: "RU", name: "Russia", flag: "🇷🇺", code: "+7" },
  { cca2: "RW", name: "Rwanda", flag: "🇷🇼", code: "+250" },
  { cca2: "BL", name: "Saint Barthelemy", flag: "🇧🇱", code: "+590" },
  { cca2: "SH", name: "Saint Helena", flag: "🇸🇭", code: "+290" },
  { cca2: "KN", name: "Saint Kitts and Nevis", flag: "🇰🇳", code: "+1869" },
  { cca2: "LC", name: "Saint Lucia", flag: "🇱🇨", code: "+1758" },
  { cca2: "MF", name: "Saint Martin", flag: "🇲🇫", code: "+590" },
  { cca2: "PM", name: "Saint Pierre and Miquelon", flag: "🇵🇲", code: "+508" },
  ...
  { cca2: "SX", name: "Sint Maarten", flag: "🇸🇽", code: "+1721" },
  ...
  { cca2: "GS", name: "South Georgia and the South Sandwich Islands", flag: "🇬🇸", code: "+500" },
  { cca2: "KR", name: "South Korea", flag: "🇰🇷", code: "+82" },
  ...
  { cca2: "SJ", name: "Svalbard and Jan Mayen", flag: "🇸🇯", code: "+4779" },
  ...
  { cca2: "TK", name: "Tokelau", flag: "🇹🇰", code: "+690" },
  { cca2: "TO", name: "Tonga", flag: "🇹🇴", code: "+676" },
  { cca2: "TT", name: "Trinidad and Tobago", flag: "🇹🇹", code: "+1868" },
  { cca2: "TA", name: "Tristan da Cunha", flag: "🇹🇦", code: "+290" },
  { cca2: "TN", name: "Tunisia", flag: "🇹🇳", code: "+216" },
  { cca2: "TR", name: "Türkiye", flag: "🇹🇷", code: "+90" },
  { cca2: "TM", name: "Turkmenistan", flag: "🇹🇲", code: "+993" },
  { cca2: "TC", name: "Turks and Caicos Islands", flag: "🇹🇨", code: "+1649" },
  { cca2: "TV", name: "Tuvalu", flag: "🇹🇻", code: "+688" },
  { cca2: "UM", name: "U.S. Minor Outlying Islands", flag: "🇺🇲", code: "+1" },
  { cca2: "VI", name: "U.S. Virgin Islands", flag: "🇻🇮", code: "+1340" },
  ...
  { cca2: "VA", name: "Vatican City", flag: "🇻🇦", code: "+379" },
  { cca2: "VE", name: "Venezuela", flag: "🇻🇪", code: "+58" },
  { cca2: "VN", name: "Vietnam", flag: "🇻🇳", code: "+84" },
  { cca2: "WF", name: "Wallis and Futuna", flag: "🇼🇫", code: "+681" },
  { cca2: "EH", name: "Western Sahara", flag: "🇪🇭", code: "+212" },
